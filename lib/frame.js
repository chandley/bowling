function Frame(nextFrame){
	this.rolls = [undefined, undefined, undefined];
  ...
  Frame.prototype.playARoll = function(pinsHit) {
    if(this.rolls[0] === undefined) {this.rolls[0] = pinsHit} else 
      if(this.rolls[1] === undefined) {this.rolls[1] = pinsHit} else {this.rolls[2] = pinsHit}
  };
  ...
  Frame.prototype.scoreIncludingBonus = function(){
    if(this.isStrike()){return (this.rolls[0] + (this.nextTwoRollsScore() || 0))};
  ...
  Frame.prototype.isStrike = function(){
   ...
   Frame.prototype.isSpare = function(){
    if (this.rolls[0] !== 10 && (this.rolls[0] + this.rolls[1]) === 10) {return true};
    return false;
  };
